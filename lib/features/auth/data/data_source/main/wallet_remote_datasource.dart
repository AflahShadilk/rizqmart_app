...
abstract class WalletRemoteDataSource {
  ...
  /// atomic operation to update balance and add transaction
...
class WalletRemoteDataSourceImpl implements WalletRemoteDataSource {
  ...
  Future<void> addTransaction(WalletTransactionModel transaction) async {
    // We refer to walletId as userId in this context
    await firestore
        .collection('wallets')
  ...
  Future<void> performWalletTransaction({
    ...
    await firestore.runTransaction((firestoreTransaction) async {
      ...
      // We need to use set because the doc ID is auto-generated by us/firestore logic 
      // but here we are using a new doc ref so set is appropriate.
      // Actually transactionRef is a DocumentReference with an ID.
